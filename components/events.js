...
export default [
  ...
  },
  {
    ...
    instagramUrl: null,
    description:
      'ミックスの子供たちとパパさん、ママさんのための交流フィールドトリップ開催。歴代の消防車を見たり、ヘリコプターに乗ったりして子供たちを交流させましょう。',
  },
  {
    title: 'インスタライブ',
    ...
    instagramUrl: 'https://www.instagram.com/culturalfusionhub/',
    description:
      'テーマ：カルチャルフュージョンハブを立ち上げたきっかけについて',
  },
  {
    title: 'Cultural Fusion Hub Meet up!',
    ...
    instagramUrl: null,
    description:
      'ミックスの子供たちとパパさん、ママさんのための交流会。英語でお歌を歌ったり バイリンガル教育についてお話したりしませんか？おもちゃ、お菓子飲み物（大人用）有。参加料500円',
  },
  {
    title: 'Field Trip',
    ...
    instagramUrl: null,
    description:
      '世界最高クラス1億4000万個の星々を見て涼しい時間を過ごしましょう。価格：大人 400円、子供（小学生・中学生）：100円 幼児（膝上に座る場合）：無料',
  },
  {
    title: 'シモキタおやこまちつどい市',
    ...
    instagramUrl: null,
    description:
      '親子で楽しめるワークショップ、ステージプログラム等１１時から開催しています。週末、お子様とのお出かけ先として是非お越しください。Cutlrual Fusion Hubは１３時からブースを出展しています。お時間のある方は、是非遊びに来てください！',
  },
  {
    title: 'Meetup！',
    ...
    instagramUrl: null,
    description:
      'ミックスキッズを遊ばせながら、パパさん、ママさんも情報交換や交流しませんか？９月といえば、お月見。キッズは、粘土細工や工作でお月見を楽しみましょう。パパさん、ママさんの話し合いのテーマは、異文化育児／教育の中での新たな発見です。カップル内で、育児においても様々な文化の違いを体験します。そこでの悩み、笑い、苦労を皆さんで共有できたらと思います！お時間の有る方は、その後、地区会館にあるレストランでランチ会も！',
  },
  {
    title: 'ナイトアウト',
    ...
    instagramUrl: null,
    description:
      '去年から、下北沢エリアで実施されているムーンアートナイト。去年は、満月やうさぎのインスタレーション、とても素敵でしたが、今年も実施するようです。保育園、幼稚園、学校帰りに、みんなで集まってムーンアートナイトを見に行って、そのあとに、ディナー会で楽しみましょう。',
  },
  {
    title: 'Cultural Fusion Hub x Blue Leaf Microgreens',
    start: '2023-10-15T10:00:00',
    end: '2023-10-15T11:30:00',
    stream: false,
    location: '池尻地区会館',
    googleMapsUrl: 'https://goo.gl/maps/eJ61w1NwFYnbgyqp7',
    instagramUrl: null,
    description:
      'Cultural Fusion Hub x Blue Leaf Microgreensコラボ企画： 多様性＆マイクログリーンワークショップ Blue Leaf Microgreensの代表、マシュー・ピーターソン氏をお迎えし、マイクログリーンの育て方（英語）についてのワークショップを実施します。 マシュー氏はインターナショナルスクールや様々なワークショップでも講義を開催しておられますが、この度、Cultural Fusion Hubに特別講師としてお招きすることになりました。マイクログリーンのワークショップに加え、Cultural Fusion Hubの多様性について簡単なワークショップも開催いたします。',
  },
  {
    title: 'Cultural Fusion Hub Meet Up',
    start: '2023-10-28T09:30:00',
    end: '2023-10-28T12:00:00',
    stream: false,
    location: '代田区民センター　井の頭線　新代田駅徒歩1分',
    googleMapsUrl: 'https://maps.app.goo.gl/nYrTZGQy4Z8wuzwy8',
    instagramUrl: '',
    description:
  ...
  {
    "title": "Meetup！",
    "start": "2024-06-29T10:00:00",
    "end": "2024-06-29T11:30:00",
    "stream": false,
    "location": "池尻会館　2階　第二会議室",
    "googleMapsUrl": "https://maps.app.goo.gl/auGpAFa9tnuLeYE47",
    "instagramUrl": "",
    "description":
      "今月のテーマは、躾についてです。国によって躾の仕方が違ったり、各家庭によっても違ったり。。。皆さんで共有してみましょう！また皆さんにお会いできるのを楽しみにしています！！DMお待ちしております 一家族２名迄５００円、３名以降は＋２００円 ※お菓子、飲み物あり ※事前予約要"
  },
];
